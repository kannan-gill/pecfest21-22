...
function TeamMemberCard(props) {
  ...
  var imagesource =
    "https://firebasestorage.googleapis.com/v0/b/pecfest-589fa.appspot.com/o/POR%20Images%2F" +
    namelist[0] +
    "%20" +
    namelist[1] +
    "?alt=media";
  ...
  return (
    <div className={`m-4 ${styles.membertile}`}>
      ...
      <div className="d-flex justify-content-around align-items-center w-50 m-auto mt-3">
        <a href={props.member.instagram}>
          <Instagram className={`fa fa-lg ${styles.instagram}`} />
        </a>
